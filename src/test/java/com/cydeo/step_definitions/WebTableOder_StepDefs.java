...
public class WebTableOder_StepDefs {
   ...
   // Select select; if you have more than one dropdown you can use it this way like globally
    // you will use a lot when you are in work environment
    ...
    public void user_selects_product_type(String string) {
        // if you have only one dropDown, you can use it this way
        // more than one make it globally like line 25, Remove first select for line 32 and 33
        Select select = new Select(webTableOrderPage.productTypeDropdown);
        select.selectByVisibleText(string);
                    // when you pass the argument string, it would be your parameterization /see it from the feature/
    ...
    public void user_enters_quantity(Integer int1) {
      ...
      //  webTableOrderPage.inputQuantity.clear();
        ...
        webTableOrderPage.inputQuantity.sendKeys(Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE);
